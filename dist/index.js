...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const arn = core.getInput("certificate");
            core.debug(`Certificate ARN is ${arn}`);
            const awsCredentials = {
                AWS_ACCESS_KEY_ID,
                AWS_SECRET_ACCESS_KEY,
            };
            execCDK("bootstrap", Object.assign(Object.assign({}, awsCredentials), { CDK_DEPLOY_REGION: "us-east-1", DOMAIN: domain, FOLDER: publish_dir, ARN: arn }));
            execCDK("deploy --require-approval never", Object.assign(Object.assign({}, awsCredentials), { DOMAIN: domain, FOLDER: publish_dir, ARN: arn }));
        }
        catch (error) {
